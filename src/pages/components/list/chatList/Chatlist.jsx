         ...
         {chatUsers.map(user => (
           <div className='item' key={user.user_id}>
             ...
             <div className='texts'>
               ...
               <small class="inline-block bg-blue-500 text-white rounded-full w-8 h-8 text-center flex items-center justify-center float-right">{user.message_count}</small>
